        ...
        $listId = '1412';  // add list id here in save file
        $listUrl = 'Littletapebigtape'; // add list url here in save file
        $creatorId = 2;     // add creatorId here in save file
        $currentUser = '0';
...
<html>
    <head>
        ...
        <title>GL JBoggan2012 Little tape big tape</title> <!-- Change in the save file -->
    ...
    <body>
        ...
        <div class="container" name="list">
            ...
            <div class="row">
                ...
                <h1 align="center">Little tape big tape <span id="costOfList">$20.00 cash</span></h1> <!-- change these in saved file-->
                <h3 align="center">Topic: Music/Charts</h3> <!-- change these in saved file -->
                <h4 align="center">Created by: JBoggan2012</h4>
                ...
                <div class="col-lg-12">
                  ...
                  <?php  if($creatorId == $currentUser){ ?>
                        <form method="post" action="JBoggan2012Littletapebigtape.php"> <!--  change in save file -->
