        ...
        $listId = '1413';  // add list id here in save file
        $listUrl = 'Timewilltell'; // add list url here in save file
        $creatorId = 1;     // add creatorId here in save file
        $currentUser = '0';
...
<html>
    <head>
        ...
        <title>GL Jibril CK Stewart Time will tell</title> <!-- Change in the save file -->
    ...
    <body>
        ...
        <div class="container" name="list">
            ...
            <div class="row">
                ...
                <h1 align="center">Time will tell <span id="costOfList">$100</span></h1> <!-- change these in saved file-->
                <h3 align="center">Topic: Disaster Prep/Items</h3> <!-- change these in saved file -->
                <h4 align="center">Created by: Jibril CK Stewart</h4>
                ...
                <div class="col-lg-12">
                  ...
                  <?php  if($creatorId == $currentUser){ ?>
                        <form method="post" action="JibrilCKStewartTimewilltell.php"> <!--  change in save file -->
