        ...
        $listId = '1410';  // add list id here in save file
        $listUrl = 'l'; // add list url here in save file
...
<html>
    <head>
        ...
        <title>GL xxxTenFreakyBones l</title> <!-- Change in the save file -->
    ...
    <body>
        ...
        <div class="container" name="list">
            ...
            <div class="row">
                ...
                <h1 align="center">l <span id="costOfList">$</span></h1> <!-- change these in saved file-->
                ...
                <div class="col-lg-12">
                  ...
                  <?php  if($creatorId == $currentUser){ ?>
                        <form method="post" action="xxxTenFreakyBonesl.php"> <!--  change in save file -->
